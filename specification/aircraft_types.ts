...
export const AircraftCodeNameTuples = [
  ...
  ["rv10", "Van's RV-10"],
  ["genericSingleFixedPiston", "Other Single Engine Fixed-Gear Piston Aircraft"],
  ["genericSingleComplexPiston", "Other Single Engine Complex Piston Aircraft"],
  ["genericTwinPiston", "Other Twin Piston Aircraft"],
  ["genericSingleComplexTurbine", "Other Single Turbine Complex Aircraft"],
  ["genericTwinTurbine", "Other Twin Turbine Aircraft"],
  ["genericSingleJet", "Other Single Jet Aircraft"],
  ["genericTwinJet", "Other Twin Jet Aircraft"],
  ["genericSinglePistonHelicopter", "Other Single Engine Piston Helicopter"],
  ["genericSingleTurbineHelicopter", "Other Single Turbine Helicopter"],
